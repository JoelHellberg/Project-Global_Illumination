...
std::vector<Rectangle> defineRectangles() {
	...
	Rectangle wallBack(glm::vec3(-3.0, 0.0, 5.0), glm::vec3(0.0, -6.0, 5.0), glm::vec3(0.0, -6.0, -5.0), glm::vec3(-3.0, 0.0, -5.0), Material(ColorDBL(1.0, 1.0, 0.0), false));
	rectangles_out.push_back(wallBack);
	Rectangle wallRight(glm::vec3(0.0, -6.0, 5.0), glm::vec3(10.0, -6.0, 5.0), glm::vec3(10.0, -6.0, -5.0), glm::vec3(0.0, -6.0, -5.0), Material(ColorDBL(0.0, 1.0, 0.0), false));
	rectangles_out.push_back(wallRight);
	Rectangle wallFrontR(glm::vec3(10.0, -6.0, 5.0), glm::vec3(13.0, 0.0, 5.0), glm::vec3(13.0, 0.0, -5.0), glm::vec3(10.0, -6.0, -5.0), Material(ColorDBL(1.0, 1.0, 1.0), true));
	rectangles_out.push_back(wallFrontR);

	// Walls infront of y (x, 6.0, z)
	Rectangle wall4(glm::vec3(-3.0, 0.0, 5.0), glm::vec3(-3.0, 0.0, -5.0), glm::vec3(0.0, 6.0, -5.0), glm::vec3(0.0, 6.0, 5.0), Material(ColorDBL(1.0, 0.0, 1.0), false));
	rectangles_out.push_back(wall4);
	Rectangle wallLeft(glm::vec3(0.0, 6.0, 5.0), glm::vec3(0.0, 6.0, -5.0), glm::vec3(10.0, 6.0, -5.0), glm::vec3(10.0, 6.0, 5.0), Material(ColorDBL(0.0, 0.0, 1.0), false));
...
std::vector<Triangle> defineTriangles() {
	...
	Triangle floorBehindL(glm::vec3(0.0, 0.0, -5.0), glm::vec3(0.0, 6.0, -5.0), glm::vec3(-3.0, 0.0, -5.0), Material(ColorDBL(0.5, 0.5, 0.5), false));
	triangles_out.push_back(floorBehindL);
	Triangle floorBehindR(glm::vec3(0.0, 0.0, -5.0), glm::vec3(-3.0, 0.0, -5.0), glm::vec3(0.0, -6.0, -5.0), Material(ColorDBL(0.5, 0.5, 0.5), false));
	triangles_out.push_back(floorBehindR);

	// Define the roof (behind the camera) as two orthogonal triangles
	Triangle roofBehindL(glm::vec3(0.0, 0.0, 5.0), glm::vec3(-3.0, 0.0, 5.0), glm::vec3(0.0, 6.0, 5.0), Material(ColorDBL(0.5, 0.5, 0.5), false));
	triangles_out.push_back(roofBehindL);
	Triangle roofBehindR(glm::vec3(0.0, 0.0, 5.0), glm::vec3(0.0, -6.0, 5.0), glm::vec3(-3.0, 0.0, 5.0), Material(ColorDBL(0.5, 0.5, 0.5), false));
